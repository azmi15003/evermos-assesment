    ...
    <section class="container">
      ...
      <div class="flex flex-direction-responsive" style="margin-top: 20px;">
        ...
        <div class="product-information relative" v-else>
          ...
          <div>
          <br>
          <button class="button-add-cart pointer">TAMBAHKAN KE KERANJANG</button>
...
export default {
  ...
  computed: {
    isWishList() {
      this.product.isWishList
      return (this.productId in this.$store.state.wishlist) ? this.$store.state.wishlist[this.productId] : this.product.isWishList
    }
  },
  async mounted() {
  ...
  methods: {
    async getDetailProduct() {
      ...
      this.imageDetail = this.product.listImage[0]
      this.loading = false
    },
